         ...
         <hr style="border-top: 3px double #8c8b8b;">
                ...
                <div class="table-responsive" style="margin-top: 10px">
                    <table class="table table-bordered table-hover" id="purchaseTable">
                        <thead>
                             <tr>
                                 <th class="text-center" width="20%">Select Product <i class="text-danger">*</i></th> 
                        ...
                        <tbody id="addPurchaseItem">
                            <tr>
                                <td class="span3 supplier">
                                  <select class="form-control" id="unit" name="product_id[]" >
                                                            <option value="">Select One</option>                                          
                               ...
                               <td class="wt">
                                        <input type="text" id="available_quantity" class="form-control text-right stock_ctn_1" placeholder="0.00" readonly="" autocomplete="off">
                                    </td>
                                
                                    <td class="text-right">
                                        <input type="text" name="quantity[]" id="cartoon_1" class="form-control text-right store_cal_1" onkeyup="calculate_store(1);" onchange="calculate_store(1);" placeholder="0.00" value="" min="0" tabindex="6" autocomplete="off">
                                    </td>
                                    <td class="test">
                                        <input type="text" name="rate[]" onkeyup="calculate_store(1);" onchange="calculate_store(1);" id="product_rate_1" class="form-control product_rate_1 text-right" placeholder="0.00" value="" min="0" tabindex="7" autocomplete="off">
                                    </td>
                                   

                                    <td class="text-right">
                                        <input class="form-control total_price text-right" type="text" name="total_amount[]" id="total_price_1" value="0.00" readonly="readonly" autocomplete="off">
                                    </td>
                                    <td>
                        ...
                        <tfoot>
                                ...
                                <td class="text-right">
                                    <input type="text" id="total" class="text-right form-control" name="total_amoun" value="0.00" readonly="readonly" autocomplete="off">
                                </td>
                            ...
                            <tr>
                                ...
                                <td class="text-right">
                                    <input type="text" id="tdiscount" class="text-right form-control" name="total_discount" value="0.00" readonly="readonly" autocomplete="off">
                                </td>
                            ...
                            <tr>
                                ...
                                <td class="text-right">
                                    <input type="text" id="grandTotal" class="text-right form-control" name="grand_total_amount" value="0.00" readonly="readonly" autocomplete="off">
                                </td>
                            </tr>
  ...
  function addPurchaseOrderField1(divName){
      ...
      if (count == limits)  {
         ...
         newdiv = document.createElement("tr");
          ...
          newdiv.innerHTML ='<td class="span3 supplier"><select class="form-control" id="unit" name="product_id[]" >'+
                                                            '<option value="">Select One</option>'+                     
                                                           '@foreach ($products as $product);'+
                                                            '<option value="{{$product->id}}">{{$product->product_name}}</option>'+
                                                           ' @endforeach'+
                                                           
                                                        '</select><input type="hidden" name="" required class="form-control product_code productSelection" onkeypress="product_pur_or_list('+ count +');" placeholder="Item code" id="product_code_'+ count +'" tabindex="'+tab1+'" > <input type="hidden" class="autocomplete_hidden_value product_id_'+ count +'" name="" id="SchoolHiddenId"/>  <input type="hidden" class="sl" value="'+ count +'">  <input type="hidden" name="" class="form-control product_name " placeholder="Item Name" id="product_name_'+ count +'" tabindex="5" readonly> </td>  <td class="wt"> <input type="text" id="available_quantity_'+ count +'" class="form-control text-right stock_ctn_'+ count +'" placeholder="0.00" readonly/> </td><td class="text-right"><input type="text" name="quantity[]" tabindex="'+tab2+'" required  id="cartoon_'+ count +'" class="form-control text-right store_cal_' + count + '" onkeyup="calculate_store(' + count + ');" onchange="calculate_store(' + count + ');" placeholder="0.00" value="" min="0"/>  </td><td class="test"><input type="text" name="rate[]" onkeyup="calculate_store('+ count +');" onchange="calculate_store('+ count +');" id="product_rate_'+ count +'" class="form-control product_rate_'+ count +' text-right" placeholder="0.00" value="" min="0" tabindex="'+tab3+'"/></td><td class="text-right"><input class="form-control total_price text-right total_price_'+ count +'" type="text" name="total_amount[]" id="total_price_'+ count +'" value="0.00" readonly="readonly" /> </td><td> <input type="hidden" id="total_discount_1" class="" /><input type="hidden" id="all_discount_1" class="total_discount" /><button style="text-align: right;" class="btn btn-danger red" type="button" value="Delete" onclick="deleteRow(this)" tabindex="8">Delete</button></td>';
