        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="card">
                    ...
                    <form action="#" class="form-vertical" id="" name="" enctype="multipart/form-data" method="post" accept-charset="utf-8">
                    <div class="card-body">
                        <div class="row">
                          <div class="col-sm-6">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <input class="datepicker form-control" type="text" size="50" name="invoice_date" id="date" required value="2019-03-31" tabindex="6" />
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="table-responsive" style="margin-top: 10px">
                            <table class="table table-bordered table-hover" id="normalinvoice">
                                ...
                                <tbody id="addinvoiceItem">
                                    <tr>
                                         <td>
                                            <input name="product_code" id="product_code" class="form-control text-left productSelection" value="" onkeypress="invoice_productList(1);"  type="text" placeholder="item code">
